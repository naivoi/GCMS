<?php
	...
	if (MAIN_INIT == 'admin' && $isAdmin) {
		...
		// รายการต่อหน้า
		$list_per_page = gcms::getVars('GET,COOKIE', 'count,index_listperpage', 30);
		...
		// add
		$content[] = '<fieldset>';
		$content[] = '<a class="button add" href="{URLQUERY?module=index-write&owner=index&src=index-pages}"><span class=icon-plus>{LNG_ADD_NEW} {LNG_PAGE}</span></a>';
		$content[] = '</fieldset>';
		// search
