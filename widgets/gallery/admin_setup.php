<?php
	...
	if (MAIN_INIT == 'admin' && $isAdmin) {
		...
		$content[] = '<span class="g-input icon-tags"><input type=text id=gallery_tags name=gallery_tags value="'.(empty($config['widget_gallery_tags']) ? '' : $config['widget_gallery_tags']).'" title="{LNG_WIDGETS_GALLERY_TAGS_COMMENT}"></span>';
		...
		$content[] = '<span class="g-input icon-gallery"><input type=number id=gallery_album_id name=gallery_album_id value="'.(empty($config['widget_gallery_album_id']) ? '' : $config['widget_gallery_album_id']).'" title="{LNG_WIDGETS_GALLERY_AID_COMMENT}"></span>';
		...
		$content[] = '<span class="g-input icon-user"><input type=number id=gallery_user_id name=gallery_user_id value="'.(empty($config['widget_gallery_user_id']) ? '' : $config['widget_gallery_user_id']).'" title="{LNG_WIDGETS_GALLERY_UID_COMMENT}"></span>';
