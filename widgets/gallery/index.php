<?php
	...
	if (defined('MAIN_INIT')) {
		...
		$config['widget_gallery_tags'] = empty($config['widget_gallery_tags']) ? '' : $config['widget_gallery_tags'];
		$config['widget_gallery_album_id'] = empty($config['widget_gallery_album_id']) ? 0 : $config['widget_gallery_album_id'];
		$config['widget_gallery_user_id'] = empty($config['widget_gallery_user_id']) ? 0 : $config['widget_gallery_user_id'];
