...
CREATE TABLE IF NOT EXISTS `{prefix}_textlink` (`id` int(11) NOT NULL auto_increment,`text` text collate utf8_unicode_ci NOT NULL,`url` text collate utf8_unicode_ci NOT NULL,`publish_start` int(11) NOT NULL,`publish_end` int(11) NOT NULL,`logo` text collate utf8_unicode_ci NOT NULL,`width` int(11) NOT NULL,`height` int(11) NOT NULL,`type` varchar(11) collate utf8_unicode_ci NOT NULL,`published` smallint(1) NOT NULL,`link_order` smallint(2) NOT NULL,`last_preview` int(11) unsigned NOT NULL,`description` text collate utf8_unicode_ci NOT NULL,`template` text collate utf8_unicode_ci NOT NULL,`target` varchar(6) collate utf8_unicode_ci NOT NULL,PRIMARY KEY (`id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
