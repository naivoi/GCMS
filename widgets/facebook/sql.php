...
INSERT INTO `{prefix}_language` (`key`, `type`, `owner`, `js`, `th`) VALUES ('LNG_FACEBOOK_BORDER','text','facebook','0','Show Border');
...
INSERT INTO `{prefix}_language` (`key`, `type`, `owner`, `js`, `th`) VALUES ('LNG_FACEBOOK_SIZE_COMMENT','text','facebook','0','ตั้งค่าขนาดการแสดงผลของกรอบ Facebook Like Box');
