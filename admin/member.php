<?php
	...
	if (MAIN_INIT == 'admin' && $isAdmin) {
		...
		$order = gcms::getVars('GET,COOKIE', 'order,member_order', 0);
		...
		$bystatus = gcms::getVars('GET,COOKIE', 'bystatus,member_bystatus', -1);
		// ค้นหาสมาชิกจากสถานะ
		if ($bystatus > -1) {
		...
		// รายการต่อหน้า
		$list_per_page = gcms::getVars('GET,COOKIE', 'count,member_listperpage', 30);
		...
		setCookie('member_listperpage', $list_per_page, time() + 3600 * 24 * 365);
		// title
