<?php
	...
	if (MAIN_INIT == 'admin' && $isAdmin) {
		...
		$content[] = '<span class="g-input icon-language"><input type=text title="{LNG_EMAIL_CHARSET_COMMENT}" name=email_charset id=email_charset value="'.$config['email_charset'].'" maxlength=20></span>';
