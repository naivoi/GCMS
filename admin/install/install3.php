<?php
	if (INSTALL_INIT == 'install') {
		...
		echo '<p class=row><label for=email>ที่อยู่อีเมล์</label><input type=email size=70 id=email name=email maxlength=255 value="'.$email.'" autofocus required></p>';
		echo '<p class="row comment">ที่อยู่อีเมล์สำหรับผู้ดูแลระบบสูงสุด ใช้ในการการเข้าระบบ</p>';
