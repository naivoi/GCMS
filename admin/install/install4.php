<?php
	if (INSTALL_INIT == 'install') {
		...
		if (!empty($error)) {
			...
			echo '<p>ที่อยู่อีเมล์สำหรับจดหมายที่ส่งโดยอัตโนมัติจากระบบ</p>';
			echo '<p class=row><label for=reply>ที่อยู่อีเมล์</label><input type=email size=50 id=reply name=reply value="'.$reply.'" required></p>';
			echo '<p class="row comment">ที่อยู่อีเมล์สำหรับการส่งจดหมายจากระบบ เช่นการสมัครสมาชิก การลืมรหัสผ่าน ซึ่งมักจะไม่ต้องการการตอบกลับมายังผู้ส่ง ปกติจะเป็น no-reply</p>';
